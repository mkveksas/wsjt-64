...
End of line information::
 ...
 An additional character following 'P' indicates that the decode was obtained from
 averaging a number of previous messages.  For example q34 would signify a Q65 decode,
 with AP type 3 from 4 messages. A '*' character indicates that 10 or more prior messages
 contributed to that decode.
